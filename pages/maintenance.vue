<template>
  <div>
    <div class="container">
      ...
      <p class="time">We will be back on {{ time }}</p>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      time: "Today, 10:00 PM",
      message:
        "Our developers are hard at work updating your system. Please wait while we do this. We have also made the spinning cogs to distract you !"
    };
  }
};
</script>
